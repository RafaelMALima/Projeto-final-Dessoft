...
while jogo == True:
    ...
    if menu_principal == True:
        ...
        desenha_texto("Seu gato foi raptado por um culto maligno de magos, e só você pode salvá-lo!", fonte_pequena,
                      ((255, 255, 255)), (largura // 2) - 700, 850)
        desenha_texto("Use suas setas para andar, e o espaço para pular!", fonte_pequena, ((255, 255, 255)),
                      (largura // 2) - 700, 900)
                ...
                for event in pygame.event.get():
                    ...
                    if event.type == pygame.KEYDOWN:
                        if event.key == pygame.K_q:
                            ...
                            quit
                tela.blit(fundo, (0, 0))
                desenha_texto("Parabéns! Você conseguiu salvar o seu gato!", fonte_enorme, (0, 0, 1),
                              (largura / 2) - 750, altura / 2 - 100)
                desenha_texto("Pressione Q para fechar o jogo", fonte_pequena, (0, 0, 1), (largura / 2) - 500,
                              altura / 2 + 300)
                pygame.display.update()
